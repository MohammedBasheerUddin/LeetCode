...
class Solution:
    def addTwoNumbers(self, l1: ListNode, l2: ListNode) -> ListNode:
        ...
        sum1 = str(int(str1)+int(str2))[::-1]       # convert the str1 and str2 to int and perform addition operation and then store them back in form of string  in reverse order [::-1] used for storing in reverse order
        ...
        return dummy.next                           # dummy points to newNode's head, returning dummy will include the first value too .i.e(0) so, for skipping first element return dummy.next 
